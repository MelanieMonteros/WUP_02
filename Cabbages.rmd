...
The comparison between the two data analysis from the bexplot c39 and c52 shows the exact median for both and shows additional data such as height from the boxplet which is being represented in Q3 and Q1.
## Inferential Results
